            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  type="number"
                  value={form.half_sheet_price}
                  onChange={(e) => setForm({ ...form, half_sheet_price: parseFloat(e.target.value) || 0 })}
                  min="0"
                  step="1"
                  placeholder="Price for half sheet"
                />
              ...
              <div className="form-group">
                ...
                <input
                  type="number"
                  value={form.full_sheet_price}
                  onChange={(e) => setForm({ ...form, full_sheet_price: parseFloat(e.target.value) || 0 })}
                  min="0"
                  step="1"
                  placeholder="Price for full sheet"
                />
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, half_sheet_bonus: parseInt(e.target.value) || 0 })}
                  min="1"
                  max="10000"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, full_sheet_bonus: parseInt(e.target.value) || 0 })}
                  min="1"
                  max="10000"
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  type="number"
                  value={form.tickets}
                  onChange={(e) => setForm({ ...form, tickets: parseInt(e.target.value) || 0 })}
                  min="1"
                  max="10000"
