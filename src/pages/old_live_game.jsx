...
// //         // ✅ ONLY update if called_numbers has data
...
// //         } else {
// //           console.log("ℹ️ No numbers in status, keeping existing numbers");
// //         }
...
// //   // Auto-sync via socket (Only if game is running)
// //   useEffect(() => {
// //     if (!selectedRoundId || !socketRef.current) return;

// //     const syncInterval = setInterval(() => {
// //       if (socketRef.current && socketRef.current.connected && isRunningRef.current) {
...
// //           {/* ✅ Only Last 10 - Recent Calls Removed */}
